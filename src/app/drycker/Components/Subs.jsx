    ...
    <div className="flex flex-col mt-6 sm:mt-8 lg:mt-12 lg:sticky lg:top-9">
      <div className="bg-[#eb7272]">
        <div className="p-4 sm:p-6 lg:p-8">
          <h1 className="font-outfit text-white text-xl sm:text-2xl mb-2 sm:mb-4">
            Vill du ha vårt nyhetsbrev?
          </h1>
          <h3 className="font-outfit text-white text-sm sm:text-md mb-4 sm:mb-6">
          ...
          <form className="space-y-3 sm:space-y-4">
            ...
            <button
              type="submit"
              className="rounded-full font-outfit text-xs sm:text-sm py-1 px-4 sm:px-6 bg-red-600 text-white hover:bg-red-700 transition-colors"
            >
              Ja, skicka till mig!
            </button>
          </form>
      ...
      <div className="mt-6 sm:mt-8">
        <h1 className="font-outfit text-lg sm:text-xl pl-2 text-black">Senaste nytt</h1>
      </div>
      <div className="font-outfit text-sm sm:text-md mt-3 sm:mt-4 p-2 text-gray-500 font-extralight w-full justify-normal leading-5">
        <Link href="#">
        ...
        <Link href="#">
          <div className="flex  flex-col cursor-pointer hover:shadow-lg transition-shadow">
            ...
            <div className="p-3 sm:p-4 bg-[#f5f5f5] flex-grow">
              <h3 className="font-outfit font-medium text-black text-lg sm:text-md">
                Ekologiskt och hållbart vin till mer grön mat?
              </h3>
              <p className="mt-1 sm:mt-2 font-outfit text-gray-900 text-xs">
                8 augusti, 2024
              </p>
              <p className="text-[#694848] text-xs font-outfit mt-1 sm:mt-2">
                Jeanette Gardner
              </p>
              <p className="font-outfit text-xs text-gray-900 font-extralight mt-1 sm:mt-2 leading-relaxed sm:leading-normal">
