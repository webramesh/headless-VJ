...
// #c90022 add this to link when the page is matched with the path
        ...
        <div className="p-3 flex flex-col gap-2 md:gap-4 lg:flex-row justify-between items-center">
          ...
          <div className="flex gap-10 text-xl">
            <Link href="https://twitter.com/hashtag/Vinjournalen" target="_blank">
              <FontAwesomeIcon icon={faXTwitter} className="text-red-600 hover:text-[#1f2933]" />
            </Link>
            <Link href="https://m.facebook.com/vinjournalen" target="_blank">
              <FontAwesomeIcon icon={faFacebookF} className="text-red-600 hover:text-[#1f2933]" />
            </Link>

            <Link href="https://www.instagram.com/vinjournalen.se/" target="_blank">
              <FontAwesomeIcon icon={faInstagram} className="text-red-600 hover:text-[#1f2933]" />
            </Link>
          </div>
        </div>
        <Copyright />
