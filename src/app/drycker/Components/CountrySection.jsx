    ...
    <div className="container mx-auto ">
      <div className="mt-8">
        <div className="flex flex-col lg:flex-row lg:gap-10">
          <div className="w-full lg:w-[20%] flex flex-col mb-8 lg:mb-0">
            <div className="text-xl sm:text-2xl font-outfit px-4 lg:px-0 items-start ">
          ...
          {/* RightSection */}
          <div className="w-full lg:w-[80%] flex flex-col items-start px-4 lg:px-0 lg:pl-7  gap-6">
            <div className="text-2xl sm:text-3xl font-outfit text-red-500  w-full">
              Historia om rött vin:
            </div>
            <div className="font-outfit text-base sm:text-lg max-w-4xl">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex flex-col gap-4 w-full md:w-1/2">
                <div className="text-2xl sm:text-3xl font-outfit text-red-500">
                ...
                <div className="font-outfit text-base sm:text-lg max-w-4xl">
                  ...
                  antioxidantegenskaper, vilket kan hjälpa till att skydda
            ...
            <div className="font-outfit text-2xl sm:text-3xl">Vanliga frågor om rödvin</div>
            <Accordion/>
          </div>
        </div>
      </div>
