        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 mt-6 lg:mt-12">
                <div className="w-full lg:w-[75%] flex flex-col gap-6">
                    <div className="font-outfit text-2xl sm:text-3xl lg:text-4xl ml-2 sm:ml-6 lg:ml-10">
                        <h1>Mousserande Vin</h1>
                    </div>
                    <WineComponent />
                    <div className="flex justify-between mx-4 sm:mx-8 lg:mx-16">
                        <div className="font-outfit text-base sm:text-lg text-red-600">
                            Previous
                        </div>
                        <div className="font-outfit text-base sm:text-lg text-red-600">Next</div>
                    </div>
                                        ...
                                        <div className="cursor-pointer hover:shadow-lg transition-shadow">
                                            ...
                                            <div className="p-3 lg:p-4 bg-[#f5f5f5]">
                                                ...
                                                <p className="font-outfit text-xs text-gray-900 font-extralight mt-1 lg:mt-2 leading-relaxed">
                                                    Är du alltid på jakt efter ekologiskt och
                                                    hållbart vin och kanske vill ändra din mat
                                                    till...
                                                </p>
                                            </div>
                                        </div>
