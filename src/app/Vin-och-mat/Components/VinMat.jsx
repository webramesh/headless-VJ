    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row lg:gap-10">
        ...
        <div className="w-full lg:w-3/4 flex flex-col gap-4 mt-8 lg:mt-12">
          ...
          <h1 className="font-outfit text-3xl lg:text-4xl">Vin & Mat</h1>
          <p className="font-outfit text-base lg:text-lg text-slate-600">
            Dyk in i den fascinerande världen av vin och mat på Vinjournalen.se.
            Upptäck artiklar som tar upp allt från mat- och vinparning till
            djupgående utforskningar av olika vinsorter. Perfekt för nybörjare
            och vinälskare som vill utöka sin kunskap och uppskattning av mat
            och vin.
          </p>
          <p className="font-outfit text-slate-600 text-base lg:text-lg">
            Behöver du hjälp att hitta den perfekta kombinationen till din
            maträtt?
            <span className="text-red-600 font-outfit">
              Hör då av dig till oss på Vinjournalen så ska vi
            </span>
          ...
          <div className="space-y-4">
            ...
            <Card />
            <Accordion />
            <div className="font-outfit text-base lg:text-lg pl-3 text-slate-600">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Dignissimos distinctio quibusdam fugit nobis modi itaque vero
              porro sunt, dolore corrupti quidem deleniti consequatur, eum culpa
              earum maxime illum dolores ratione cum quae?
              <br />
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet
              voluptas adipisci architecto recusandae mollitia velit maiores
              accusantium voluptatum possimus ut odit cumque id, reiciendis ab
              consectetur dolorum optio quam harum, voluptate dolor! Minima
              temporibus, eum itaque provident ratione cum animi quisquam nisi
              quas corrupti tenetur fugit! Nesciunt est accusamus repudiandae ea
              veniam ipsum beatae! Magnam rem repudiandae laboriosam dignissimos
              provident minima quaerat, laudantium dolor!
            </div>
            <CatAccordion />
          </div>
        </div>
