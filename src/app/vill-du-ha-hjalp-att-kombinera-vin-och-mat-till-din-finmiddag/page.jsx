        ...
        <>
            ...
            <div className="container mx-auto flex  lg:flex-row gap-6 lg:gap-12 mt-4 lg:mt-10 bg-slate-50  p-4">
                <div className="md:w-2/3 ">
                    ...
                    />
                    <p>
                        Vinjournalen.se har tillsammans med sitt nätverk av dryckesentusiaster en
                        god kunskap om drycker och hur de ska kombineras med mat. Vi jobbar med
                        erfarna sommelierer som vi för denna tjänst kommer få hjälp av för att
                        hjälpa dig med förslag om vin tilll din specifika maträtt. Vanligen så tar
                        det oss 1-2 dagar innan vi återkommer till dig med vårt förslag så vänligen
                        se till att inte höra av dig i sista stund.
                    </p>
                    <CombineWineFoodForm />
