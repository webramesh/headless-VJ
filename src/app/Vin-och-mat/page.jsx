                    ...
                    <div className="w-full lg:w-3/4 flex flex-col gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="font-outfit text-base lg:text-lg pl-3 text-slate-600">
                                ...
                                Dignissimos distinctio quibusdam fugit nobis modi itaque vero porro
                                sunt, dolore corrupti quidem deleniti consequatur, eum culpa earum
                                maxime illum dolores ratione cum quae?
                                <br />
