    ...
    <div>
      ...
      />
            <div className="container mx-auto flex flex-col w-full py-10 px-4 md:px-8 lg:px-12">
                ...
                <h2 className="mb-6 text-2xl">Hur behandlar vi dina uppgifter?
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Hur skyddar vi dina personuppgifter?
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Måste du tillhandahålla dina personuppgifter till oss och vad händer om du inte gör det?
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Vilka kan få tillgång till dina personuppgifter?
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Vilka rättigheter har du att påverka hur vi behandlar dina personuppgifter?
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Återkalla ditt samtycke till utskick av nyhetsbrev
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Rätt till tillgång
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Rätt till rättelse
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Rätt till radering (rätten att bli bortglömd)
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Rätt till begränsning av behandling
                </h2>
                <p className="mb-6">
                Gäller inte hos oss då vi endast har din e-postadress/telefonnummer.
                </p>

                <h2 className="mb-6 text-2xl">Rätt att invända mot behandling
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Rätt att inge klagomål
                </h2>
                <p className="mb-6">
                ...
                <h2 className="mb-6 text-2xl">Rätt till dataportabilitet
                </h2>
                <p className="mb-6">
