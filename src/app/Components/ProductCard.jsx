    ...
    return (
        <div className="border-2 shadow-md hover:shadow-lg transition-shadow duration-300 p-6">
            <div className="flex flex-col gap-2 items-start">
                ...
                <div className="font-outfit text-red-500 mt-2 text-sm">Rött Vin | Vin</div>
                <div className="font-outfit leading-6 text-lg font-thin">
                    Château Ducluzeau Les Grands Chais de France 2017
                </div>
                <div className="flex gap-2 mt-4 items-center">
                    ...
                    <div className="text-xs font-outfit">
                        Frankrike | Bordeaux | Castillon Côtes ...
                    </div>
                </div>
                <div className="text-lg font-outfit mt-2">434:-</div>
            </div>
        </div>
    );
}
