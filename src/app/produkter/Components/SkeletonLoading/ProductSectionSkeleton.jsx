      ...
      <div className="flex flex-col md:flex-row gap-6 mt-4 py-8 lg:py-16">
        ...
        <div className="w-full md:w-1/3">
          <div className="md:sticky md:top-4">
            ...
            <div className="mt-4 md:hidden animate-pulse">
        ...
        <div className="flex flex-col w-full md:w-2/3">
          <div className="md:block hidden h-8 w-3/4 bg-gray-300 rounded animate-pulse"></div>
          <div className="md:block hidden h-4 w-1/2 bg-gray-300 rounded animate-pulse mt-2"></div>
