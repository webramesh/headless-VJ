        ...
        <div className="w-full lg:w-[75%] lg:sticky lg:top-0 lg:self-start">
          <div className="flex flex-col gap-6">
            <div className="text-base lg:text-lg ">
              Vinjournalen.se är ett magasin online om dryck och mat som växer i rask takt. Magasinet har en bred
              geografisk målgrupp och idag cirka 100 000+ unika besökare, varav 95% är organisk trafik. Idag så jobbar
              vi nära importörer och producenter och partners för att leverera bra redaktionellt innehåll till våra
              läsare, men vi har även visa utrymmen för annonsering.
            </div>
            <div className="text-base lg:text-lg ">
              Är du intresserade av att nå ut till en vinsugen målgrupp? Kontakta oss idag så berättar vi mer om
              möjligheterna att annonsera på VinJournalen.se! Du kan också ta kontakt med Jeanette om du är intresserad
              av att tipsa om oss relevanta nyheter för vår målgrupp, exempelvis nya drycker eller kommande producent
              besök som riktar sig mot konsument.
            </div>
            <div className=" text-base lg:text-lg text-semibold text-gray-600">
              <i>Annonsering</i>
            </div>
            <div className="text-base lg:text-lg ">sales@vinjournalen.se</div>

            <div className=" text-base lg:text-lg text-semibold text-gray-600">
              <i>För redaktionella samarbeten och tips</i>
            </div>
            <div className="text-base lg:text-lg ">Jeanette Gardner</div>
            <div className="text-base lg:text-lg ">jeanette@vinjournalen.se</div>
