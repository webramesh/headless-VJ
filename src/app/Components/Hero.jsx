  ...
  return (
    <div className="container mt-6 mx-auto p-2">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        {/* Main Article */}
        <a href="/article/vin-pasta" className="w-full lg:w-1/2 bg-[#f5f5f5] overflow-hidden">
          ...
          <div className="p-4">
            <h2 className=" font-medium text-black text-lg mt-4 sm:mt-8">Vin & pasta - vilka viner passar bäst?</h2>
            <p className="mt-4  text-gray-900 text-xs">13 augusti, 2024</p>
            <p className="text-[#694848] text-xs  mt-2">Jeanette Gardner</p>
            <p className=" text-sm text-gray-900 font-extralight mt-4 leading-relaxed">
              Hur matchar man vin & pasta till olika klassiska pastarättter? Carbonara, Lasagne, Alfredo och med
              ingredienser som svamp, tomatsås, pesto,…
            </p>
          </div>
        </a>
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-8">
          ...
          <a href="/article/lugana">
            <div className="flex flex-col sm:flex-row gap-4 bg-[#f5f5f5] overflow-hidden">
              ...
              <div className="p-4 sm:w-2/3">
                <h3 className=" font-medium text-black text-lg">Hört om Lugana - den spännande?</h3>
                <p className="mt-2  text-gray-900 text-xs">6 augusti, 2024</p>
                <p className="text-[#694848] text-xs  mt-2">Jeanette Gardner</p>
                <p className=" text-sm text-gray-900 font-extralight mt-2 leading-relaxed">
                  Lugana är en naturskön region som producerar vitt vin i Italien vid den södra änden av ....
                </p>
              </div>
            </div>
          </a>
          ...
          <a href="/article/vanliga">
            <div className="flex flex-col sm:flex-row gap-4 bg-[#f5f5f5] overflow-hidden">
              ...
              <div className="p-4 sm:w-2/3">
                <h3 className=" font-medium text-black text-lg">16 vanliga myter om vin som inte är sanna!</h3>
                <p className="mt-2  text-gray-900 text-xs">1 augusti, 2024</p>
                <p className="text-[#694848] text-xs  mt-2">Jeanette Gardner</p>
                <p className=" text-sm text-gray-900 font-extralight mt-2 leading-relaxed">
                  Våra vanligaste myter om vin, som ni vet är sånt man hör, sant eller inte? Här är...
                </p>
              </div>
            </div>
          </a>
