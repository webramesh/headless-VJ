function JoinTeamForm() {
  return (
    <>
      <h2 className="text-xl lg:text-2xl my-2 lg:my-4 font-semibold">Vill du vara med i vårt team?</h2>
      <p className="text-sm lg:text-base mb-1 lg:mb-2">Vi söker nu skribenter och vinprovare</p>
      <form className="my-3 md:my-5 text-sm lg:text-base">
        {/* for name */}
        <div className="mb-4">
          <label htmlFor="first_name" className="block mb-2 font-bold text-gray-900">
            Namn
            <span className="italic text-xs lg:text-sm  text-[#eb7272] font-normal">(Obligatoriskt)</span>
          </label>
        ...
        <div className="mb-4">
          <label htmlFor="email" className="block mb-2   font-bold text-gray-900">
            E-post
            <span className="italic text-xs lg:text-sm  text-[#eb7272]">(Obligatoriskt)</span>
          </label>
          <input
            type="email"
            id="email"
        ...
        <div className="mb-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="flex gap-1">
              <input type="radio" id="moreThanEighty" name="age" value="moreThanEighty" />
        ...
        <div className="mb-4">
          ...
          <div className="flex gap-2 items-center ">
            <input type="checkbox" />
            <label htmlFor="vehicle1">Att delta som vinprovare och betygsätta viner</label>
          </div>
          <div className="flex gap-2 items-center ">
            <input type="checkbox" />
            <label htmlFor="vehicle2">Att skriva inlägg och vara del av redaktionen</label>
          </div>
        ...
        <div className="mb-4">
          ...
          ></textarea>
          <p className="mt-2">Berätta kort om dig själv och varför du vill skriva på Vinjournalen.se</p>
        </div>
        <button
          type="button"
