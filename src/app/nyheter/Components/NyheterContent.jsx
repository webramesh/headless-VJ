    ...
    <div className="container mx-auto">
      <div className="flex flex-col mt-12 gap-4 mx-4 sm:mx-8 md:mx-16 lg:mx-52 p-4 sm:p-6 shadow-2xl">
        ...
        <div className=" text-sm sm:text-base md:text-lg">
          <span className="text-red-500 ">Hem</span> » Nyheter » Bordeaux: Borgmästare vill förbjuda kryssningsfartyg
        </div>
        <div>
          <Image src={food3} alt="Food3" className="object-cover w-full" />
        </div>
        <div className=" text-base sm:text-lg">
          Pierre Hurmic, borgmästare i Bordeaux, trycker på för ett fullständigt förbud mot kryssningsfartyg som lägger
          till i stadens centrum eftersom de förstör platsens "skönhet" och att fartygen orsakar föroreningar. Han
          glömmer samtidigt bort att inresande turister vill prova regionens viner, dessa goda Bordeauxviner som gått
          sitt namn efter hamnstaden, eller besöka regionens kända vingårdar och både äta och dricka gott på
          restauranger och barer samt besöka det kända vinmuseet La Cité du Vin….
        </div>
        <div className=" text-base sm:text-lg">
          Styrande i Bordeaux har redan tidigare begränsat antalet kryssningsfartyg till bara 40 fartyg per år, men
          Pierre Hurmic, vill ha ett fullständigt förbud mot kryssningsfartyg
        </div>
        <div>Man baxnar.</div>
        <div className=" text-base sm:text-lg">
          Patrick Seguin, ordförande för Bordeaux-Girondes handels- och industrikammare, tror att detta kommer att få
          stora konsekvenser för Bordeaux handel. Det anser restauranger och vingårdar också.
        </div>
        <div className=" text-base sm:text-lg">Man försöker nu hitta en kompromisslösning.</div>
        ...
        <div className="w-full mt-8 bg-[#eb7272]">
          <div className="p-4 lg:p-6">
            <h1 className=" text-white text-xl sm:text-2xl lg:text-4xl mb-4">Vill du ha vårt nyhetsbrev?</h1>
